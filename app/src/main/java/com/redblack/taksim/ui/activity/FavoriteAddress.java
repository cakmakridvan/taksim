...
public class FavoriteAddress extends AppCompatActivity {

    private ImageButton bck_favorite;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        text = findViewById(R.id.txtView_favorite);
        bck_favorite = findViewById(R.id.back_favorite);
        bck_favorite.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        AutocompleteSupportFragment autocompleteFragment = (AutocompleteSupportFragment)
                getSupportFragmentManager().findFragmentById(R.id.autocomplete_fragment_favorite);

        //Disable Search icon of autocomplete fragment and change text of it
        autocompleteFragment.setHint("Favori adresinizi giriniz?");
        ...
        autocompleteFragment.setOnPlaceSelectedListener(new PlaceSelectionListener() {
            ...
            public void onPlaceSelected(Place place) {
                ...
                Paper.book().write("favorite_address",address);
                finish();
